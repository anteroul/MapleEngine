...
unsigned short* Geometry::createTrianglesForQuad (unsigned short topLeft, unsigned short bottomLeft, unsigned short bottomRight, unsigned short topRight, unsigned short* indices)
{
    indices[0] = topLeft;
